...
# YouTube video counts for Dark Souls III
playtime = [0, 0, 0, 0, 0, 0, 35, 50, 0, 0, 0, 0]  # Playtime in hours
youtube_activity = [0, 0, 0, 0, 0, 0, 2, 3, 0, 0, 0, 0]  # Number of videos watched
